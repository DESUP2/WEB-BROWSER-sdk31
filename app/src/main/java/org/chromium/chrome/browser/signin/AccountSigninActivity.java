...
/**
 * An Activity displayed from the MainPreferences to allow the user to pick an account to AccountSigninView.Delegate
 * sign in to. The AccountSigninView.Delegate interface is fulfilled by the AppCompatActivity.
 */
public  abstract class AccountSigninActivity extends AppCompatActivity implements AccountSigninView.Listener , AccountSigninView.Delegate {
