...
public class LocationBarTablet extends LocationBarLayout {
    ...
    public void setShouldShowButtonsWhenUnfocused(boolean shouldShowButtons) {
        ...
        ViewCompat.setPaddingRelative(mUrlBar,
                ViewCompat.getPaddingStart(mUrlBar),
    ...
    protected void updateLayoutParams() {
        ...
        if (mSaveOfflineButton.getVisibility() == View.VISIBLE) {
            ...
            lastButtonSpace = MarginLayoutParamsCompat.getMarginEnd(saveOfflineLayoutParams);
        } else {
            MarginLayoutParams micLayoutParams = (MarginLayoutParams) mMicButton.getLayoutParams();
            lastButtonSpace = MarginLayoutParamsCompat.getMarginEnd(micLayoutParams);
        }
        ...
        MarginLayoutParamsCompat.setMarginEnd(deleteLayoutParams, lastButtonSpace);
        MarginLayoutParamsCompat.setMarginEnd(bookmarkLayoutParams, lastButtonSpace);
