 ...
 */
public abstract class SyncCustomizationFragment extends PreferenceFragmentCompat
    ...
    private void onSyncErrorCardClicked() {
        ...
        if (mCurrentSyncError == SYNC_CLIENT_OUT_OF_DATE) {
            ...
            intent.setData(
                    Uri.parse("market://details?id=" + ContextUtils.getApplicationContext().getPackageName()));
            startActivity(intent);
            return;
        }
