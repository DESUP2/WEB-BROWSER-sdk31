    ...
    public void updateSecurityIcon(int securityLevel) {
        ...
        if (id == 0) {
            ...
            mSecurityButton.setTint(
                   // LocationBarLayout.getSecurityIconResource(AppCompatResources.getColorStateList(getContext(),getSecurityLevel()),securityLevel, getToolbarDataProvider(),
                       //     getResources(), false /* omnibox is not opaque */));

                    AppCompatResources.getColorStateList(getContext(), getToolbarDataProvider().getPrimaryColor()));
