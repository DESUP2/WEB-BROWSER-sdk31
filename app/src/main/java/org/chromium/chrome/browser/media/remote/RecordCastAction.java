...
public class RecordCastAction {
    ...
    public static void remotePlaybackDeviceSelected(int playerType) {
        ...
        if (LibraryLoader.getInstance().isInitialized()) nativeRecordRemotePlaybackDeviceSelected(playerType);
    }
    ...
    public static void castDefaultPlayerResult(boolean castSucceeded) {
        if (LibraryLoader.getInstance().isInitialized()) nativeRecordCastDefaultPlayerResult(castSucceeded);
    }
    ...
    public static void castYouTubePlayerResult(boolean castSucceeded) {
        if (LibraryLoader.getInstance().isInitialized()) nativeRecordCastYouTubePlayerResult(castSucceeded);
    }
