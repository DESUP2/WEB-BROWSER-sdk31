...
public class FirstRunActivity extends AppCompatActivity implements FirstRunPageDelegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new FirstRunFlowSequencer(this, mFreProperties) {
            ...
            public void onFlowIsKnown(Bundle freProperties) {
                ...
                FirstRunActivity.this.mPagerAdapter = new FirstRunPagerAdapter(FirstRunActivity.this.getSupportFragmentManager(), FirstRunActivity.this.mPages, FirstRunActivity.this.mFreProperties);
    ...
    public void openAccountAdder(androidx.fragment.app.Fragment fragment) {
