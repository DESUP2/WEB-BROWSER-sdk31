 ...
 * associated with the current context. OnMenuItemClickListener
 */
public class BookmarkActionBar extends SelectionToolbar<BookmarkId> implements BookmarkUIObserver, OnClickListener {
    ...
    public BookmarkActionBar(Context context, AttributeSet attrs) {
        ...
        setOnMenuItemClickListener((OnMenuItemClickListener) this);
