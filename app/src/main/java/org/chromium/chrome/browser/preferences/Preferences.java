...
import static androidx.fragment.app.Fragment.instantiate;
 ...
 * androidx.preference.PreferenceActivity.
 */
public class Preferences extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            @Deprecated
            Fragment fragment = instantiate(this, initialFragment, initialArguments);
    ...
    public void onAttachedToWindow() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            if (fragment instanceof PreferenceFragmentCompat && fragment.getView() != null) {
