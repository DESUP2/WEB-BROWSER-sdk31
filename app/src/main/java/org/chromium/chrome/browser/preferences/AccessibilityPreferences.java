 ...
 */
public abstract class AccessibilityPreferences extends PreferenceFragmentCompat
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mForceEnableZoomPref = (SeekBarLinkedCheckBoxPreference) findPreference(PREF_FORCE_ENABLE_ZOOM);
    ...
    private void updateValues() {
        ...
        mTextScalePref.setValue((int) userFontScaleFactor);
        updateTextScaleSummary(userFontScaleFactor);
