...
abstract class ToolbarLayout extends FrameLayout implements Toolbar {
    ...
    public ToolbarLayout(Context context, AttributeSet attrs) {
        ...
        //mDarkModeTint =   ApiCompatibilityUtils.getColor(getResources(), R.color.dark_mode_tint);
        mDarkModeTint = AppCompatResources.getColorStateList(getContext(), R.color.dark_mode_tint);
        //mLightModeTint =  ApiCompatibilityUtils.getColorStateList(getResources(), R.color.light_mode_tint);
        mLightModeTint = AppCompatResources.getColorStateList(getContext(), R.color.light_mode_tint);
    }
