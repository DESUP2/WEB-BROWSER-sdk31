...
public class BookmarkManager implements BookmarkDelegate {
    ...
    public void destroy() {
        ...
        if (mUIObservers.size() != 0) throw new AssertionError();
    ...
    private void initializeToLoadingState() {
        ...
        mContentView.showLoadingUi();
        if (!mStateStack.isEmpty()) throw new AssertionError();
    ...
    public void notifyStateChange(BookmarkUIObserver observer) {
        ...
        switch (state) {
            ...
            case BookmarkUIState.STATE_LOADING:
                ...
                if (!mUIObservers.isEmpty()) throw new AssertionError();
                break;
            default:
                if (true) throw new AssertionError("State not valid");
                break;
        }
    }
