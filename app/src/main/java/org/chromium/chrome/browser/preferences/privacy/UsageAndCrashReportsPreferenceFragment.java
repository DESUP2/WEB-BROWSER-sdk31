 ...
 */
public abstract class UsageAndCrashReportsPreferenceFragment extends PreferenceFragmentCompat {
    private static final String PREF_USAGE_AND_CRASH_REPORTS_SWITCH = "usage_and_crash_reports_switch";
